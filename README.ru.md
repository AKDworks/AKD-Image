...
Исключения – загрузка логотипа по внешней ссылке в инструменте водяного знака и скачивание AI-модели для удаления фона. В обоих случаях выбранное изображение остаётся на устройстве пользователя. Серверы, с которых загружаются модель и среда выполнения, могут получить обычные технические сведения о подключении, например IP-адрес и User-Agent.
