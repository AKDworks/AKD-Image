...
- обрезка, поворот, отражение и скругление углов;
...
Статичные изображения поддерживаются в форматах JPG, PNG, WebP и AVIF. Полноценная работа с анимированными GIF доступна в сжатии, изменении размера, водяном знаке, обрезке, повороте, фотоэффектах, генераторе мемов, скруглении углов, пикселизации, Base64, размытии области и пометках на изображении.
