...
Основные инструменты работают с JPG, PNG, WebP и AVIF. В зависимости от выбранного инструмента результат также может быть сохранён как PDF, ZIP, Base64, Data URL или набор файлов favicon.
